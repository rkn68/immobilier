...
<body>
    <div class="grille-accueil"> <!-- Conteneur principal utilisant une grille CSS -->
        ...
        <section class="presentation"> <!-- Section de présentation -->
            <img src="img/ressources/image isik agency.png" alt="Image ISIK Agency"> <!-- Logo de l'agence -->
        ...
        <section class="slider"> <!-- Section du slider d'images -->
            <div class="container-slides"> <!-- Conteneur des slides -->
                <img src="img/ressources/maison/maison1.jpg" class="active"> <!-- Image active du slider -->
                <img src="img/ressources/maison/maison2.jpg"> <!-- Image du slider -->
                <img src="img/ressources/maison/maison3.jpg"> <!-- Image du slider -->
                <img src="img/ressources/maison/maison4.jpg"> <!-- Image du slider -->
            </div>
            <div class="cont-btn"> <!-- Conteneur des boutons de navigation du slider -->
                <button class="btn-nav left"> <!-- Bouton de navigation gauche -->
                    <img src="img/ressources/chevron-gauche.svg" alt="Chevron Gauche"> <!-- Icône du chevron gauche -->
                </button>
                <button class="btn-nav right"> <!-- Bouton de navigation droite -->
                    <img src="img/ressources/chevron-droit.svg" alt="Chevron Droit"> <!-- Icône du chevron droit -->
                </button>
            </div>
        </section>
        ...
        <section class="choix"> <!-- Section des choix -->
            ...
            <div class="cont-medias"> <!-- Conteneur des icônes de médias sociaux -->
                <a href="https://x.com/rkn_68" target="_blank"> <!-- Lien vers Twitter -->
                    <img src="img/ressources/twitter.svg" alt="Twitter"> <!-- Icône Twitter -->
                </a>
                <a href="https://www.facebook.com/erkan.isik.5264?locale=fr_FR" target="_blank"> <!-- Lien vers Facebook -->
                    <img src="img/ressources/facebook.svg" alt="Facebook"> <!-- Icône Facebook -->
                </a>
            </div>
        </section>
